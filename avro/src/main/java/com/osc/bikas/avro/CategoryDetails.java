...
public class CategoryDetails extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.osc.bikas.avro.CategoryDetails.Builder newBuilder() {
    return new com.osc.bikas.avro.CategoryDetails.Builder();
  }
   ...
   * @return A new CategoryDetails RecordBuilder
   */
  public static com.osc.bikas.avro.CategoryDetails.Builder newBuilder(com.osc.bikas.avro.CategoryDetails.Builder other) {
    if (other == null) {
      return new com.osc.bikas.avro.CategoryDetails.Builder();
    } else {
      return new com.osc.bikas.avro.CategoryDetails.Builder(other);
    }
  }
   ...
   * @return A new CategoryDetails RecordBuilder
   */
  public static com.osc.bikas.avro.CategoryDetails.Builder newBuilder(com.osc.bikas.avro.CategoryDetails other) {
    if (other == null) {
      return new com.osc.bikas.avro.CategoryDetails.Builder();
    } else {
      return new com.osc.bikas.avro.CategoryDetails.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CategoryDetails>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.osc.bikas.avro.CategoryDetails.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.osc.bikas.avro.CategoryDetails other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.categoryId)) {
        this.categoryId = data().deepCopy(fields()[0].schema(), other.categoryId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.bikas.avro.CategoryDetails.Builder setCategoryId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.bikas.avro.CategoryDetails.Builder clearCategoryId() {
      categoryId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.bikas.avro.CategoryDetails.Builder setCategoryName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.bikas.avro.CategoryDetails.Builder clearCategoryName() {
      categoryName = null;
